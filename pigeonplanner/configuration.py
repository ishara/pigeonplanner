...
class Configuration(object):
    ...
    def __defineConfiguration(self):
        ...
        self.__addOption('Options', 'theme', 1)
        ...
        ##self.__addOption('Options', 'coefformat', '%(place)s / %(out)s * 100')
        ...
        self.__addOption('Columns', 'category', 'True')
        self.__addOption('Columns', 'type', 'True')
        self.__addOption('Columns', 'weather', 'True')
        self.__addOption('Columns', 'wind', 'True')
        self.__addOption('Columns', 'comment', 'True')
