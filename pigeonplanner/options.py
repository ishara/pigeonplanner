...
class GetOptions(object):
    ...
    def _set_options(self):
        ...
        ##self.coefformat = self.conf.get('Options', 'coefformat')
        ...
        self.window_h = self.conf.getint('Window', 'window_h')
        ...
        self.coltype = self.conf.getboolean('Columns', 'type')
        self.colweather = self.conf.getboolean('Columns', 'weather')
        self.colwind = self.conf.getboolean('Columns', 'wind')
